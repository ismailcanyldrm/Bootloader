...
int main(void)
{
  /* USER CODE BEGIN 1 */
	  ...
	  GPIOE->MODER |= GPIO_MODER_MODE10_0; // output mode for PE10
	  GPIOE->OTYPER &= ~GPIO_OTYPER_OT10; // push-pull mode
	  GPIOE->OSPEEDR |= GPIO_OSPEEDER_OSPEEDR10_0; // medium speed
	  GPIOE->PUPDR &= ~GPIO_PUPDR_PUPDR10; // no pull-up, no pull-down

	  // PE10 pinini HIGH seviyesine getir
